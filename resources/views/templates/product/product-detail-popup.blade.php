<div class="product-detail-modal modal fade" id="product-detail" tabindex="-1" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div id="forgotPasswordStep1" class="modal-body">
                <div class="promo-block-v9 full-width-container" id="product-content">

                    {{--<pre> <% vm.productDetail | json %></pre>--}}

                    <div class="row product-detail-v-middle margin-l-0 margin-b-30 margin-r-0">
                        ...
                        <div ng-if="vm.productDetail.highResImages"
                             ng-class="vm.nextPrevHide ? 'col-sm-12' : 'col-sm-9'">
